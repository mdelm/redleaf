			        ...
			        <div className="container">
			            <div className="row">
			                <div className="col-md-8 m-auto">
			                    <Link to={`/dashboard/projectBoard/${project.projectIdentifier}`} className="btn btn-light">
...
const mapActionsToProps = dispatch => ({
	fetchTaskStart: (sequence, projectId, history) => dispatch(fetchTaskStart(sequence, projectId, history)),
	updateTaskStart: (task, projectId, history) => dispatch(updateTaskStart(task, projectId, history)),
